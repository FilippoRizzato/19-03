    ...
    <div class="main-content">
        <div class="product-details">
            <div class="product-image">
                <img src="<?php echo htmlspecialchars($product['image_url']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?> Album Cover">
            </div>
        ...
        <div class="alternative-images">
            ...
            <table>
                ...
                <tr>
                    <td>
                        <img src="<?php echo htmlspecialchars($product['image_url']); ?>" alt="Immagine alternativa" width="200">
                    </td>
                </tr>
            </table>
        </div>
